...
--
-- Host: localhost
-- Generation Time: Mar 09, 2022 at 07:30 PM
...
CREATE TABLE `absence_retard` (
  ...
  `type_absence_retard` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
CREATE TABLE `annee_scolaire` (
  ...
  `libel_annee_scolaire` varchar(50) DEFAULT NULL
...
(1, 2, 'Othman', 'hello je suis othman charai', '2022-03-09 09:33:01'),
(2, 1, 'admin', 'bn bnnnnbnmbbnmbnm', '2022-03-09 13:37:16');
...
CREATE TABLE `cycle` (
  ...
  `id_ecole` int(11) DEFAULT NULL,
  `libel_cycle` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `ecole` (
  ...
  `protable` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `filiere` (
  ...
  `id_serie` int(11) DEFAULT NULL,
  `id_ecole` int(11) DEFAULT NULL,
  `libel_filiere` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `formateur_classe_ecole`
--

CREATE TABLE `formateur_classe_ecole` (
  `id_formateur` int(11) NOT NULL,
  `id_classe` int(11) NOT NULL,
  `id_ecole` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `formateur_matiere_ecole`
--

CREATE TABLE `formateur_matiere_ecole` (
  `id_formateur` int(11) NOT NULL,
...
--
-- Table structure for table `inscription_annee_scolaire`
--

CREATE TABLE `inscription_annee_scolaire` (
  `id_utilisateur` int(11) NOT NULL,
  `id_ecole` int(11) NOT NULL,
  `id_annee_scolaire` int(11) NOT NULL,
  `date_inscription` datetime DEFAULT NULL,
  `etat_inscription` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `langue` (
  ...
  `libel_langue` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `matiere` (
  `id_matiere` int(11) NOT NULL,
  `id_ecole` int(11) DEFAULT NULL,
  `libel_matiere` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `niveau` (
  ...
  `id_cycle` int(11) DEFAULT NULL,
  `id_ecole` int(11) DEFAULT NULL,
  `libel_niveau` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `notification` (
  ...
  `id_utilisateur` int(11) DEFAULT NULL,
  `id_notification_categorie` int(11) DEFAULT NULL,
...
--
-- Table structure for table `notification_categorie`
--

CREATE TABLE `notification_categorie` (
  `id_notification_categorie` int(11) NOT NULL,
  `libel_notification_categorie` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `notification_envois`
--
...
CREATE TABLE `notification_envois` (
  ...
  `id_notification_statut` int(11) NOT NULL,
  `date_envoi` datetime DEFAULT NULL,
  `date_recevoir` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `notification_statut`
--

CREATE TABLE `notification_statut` (
  `id_notification_statut` int(11) NOT NULL,
  `libel_notification_statut` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `notification_traduction`
--

CREATE TABLE `notification_traduction` (
  `id_notification` int(11) NOT NULL,
  `id_langue` int(11) NOT NULL,
  `contenu_traduction` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `parametre` (
  ...
  `id_ecole` int(11) DEFAULT NULL,
  `sujet_parametre` varchar(200) DEFAULT NULL,
...
CREATE TABLE `parent_type` (
  `id_parent_type` int(11) NOT NULL,
  `libel_parent_type` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `serie` (
  ...
  `id_niveau` int(11) DEFAULT NULL,
  `id_ecole` int(11) DEFAULT NULL,
  `libel_serie` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `utilisateur` (
  `id_utilisateur` int(11) NOT NULL,
  `id_utilisateur_type` int(11) DEFAULT NULL,
  `nom` varchar(50) DEFAULT NULL,
  ...
  `confirmation_key` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `confirmed` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `password_reset_key` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `password_reset_confirmed` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `password_reset_timestamp` datetime DEFAULT NULL,
  `register_date` date NOT NULL,
  `user_role` int(4) NOT NULL DEFAULT 1,
  `last_login` datetime DEFAULT NULL,
  `banned` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
...
--
-- Table structure for table `utilisateur_langue`
--

CREATE TABLE `utilisateur_langue` (
  `id_ecole` int(11) NOT NULL,
  `id_langue` int(11) NOT NULL,
  `langue_default` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `utilisateur_type` (
  ...
  `libel_utilisateur_type` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `absence_retard`
--
