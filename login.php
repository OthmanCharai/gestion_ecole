                        ...
                        <div class="px-4 pb-3">
                            ...
                            <div class="form-wrapper" id="create">
                                ...
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <?= trans('email') ?> nom <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <?= trans('email') ?> prenom <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <?= trans('email') ?>sexe <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <?= trans('email') ?> date_nais<span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <?= trans('email') ?>adresse <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <?= trans('email') ?>portable <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            <?= trans('username') ?>photo <span class="required">*</span>
                                        </label>
